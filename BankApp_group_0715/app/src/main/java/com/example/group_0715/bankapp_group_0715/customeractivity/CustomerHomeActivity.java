...
public class CustomerHomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User user = select.getUserDetailsInfo(customerId, this);
        select.close();
    ...
    private void displayNewMessageNotification() {
        ...
        DatabaseSelectHelper select = new DatabaseSelectHelper(this);
        List<Integer> allUserMsgId = select.getAllMessagesList(customerId);
    ...
    public void goToViewAccounts(View view) {
        Intent intent = new Intent(this, ViewCustomerAccountsActivity.class);
        intent.putExtra("customerId", customerId);
        startActivity(intent);
    }

    public void goToCustomerHelp(View view) {
        Intent intent = new Intent(this, CustomerHelpActivity.class);
        intent.putExtra("customerId", customerId);
        startActivity(intent);
    }
    ...
    public void performLogout(View view){
        ...
        logoutBox.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(CustomerHomeActivity.this, WelcomeActivity.class);

...
public class AdminMakeTellerActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.admin_terminal_make_teller_activity);

    }

    public void performMakeTeller(View view) {
        ...
        try {
            ...
            if (name.equals("") || ageText.equals("") || address.equals("") || passwordText.equals("")
                ...
                int roleId = roleMap.findRoleId("TELLER", this);
        ...
        if (successState && newId != -1) {
            printMessage = "You have created a new teller. The user ID is: " + newId;
